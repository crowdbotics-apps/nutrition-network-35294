...
## Project Structure
    ...
    ├── nutrition_network_35294  # Django project configurations
...
1. Clone this repo and `cd nutrition_network_35294`
...
2. Clone this repo and `cd nutrition_network_35294`
